 ...
 * To declare a bounded type parameter, list the type parameter’s name, followed by the extends keyword, followed by its upper bound, similar like below method.
 *
 ...
 * In this case, A can be an interface or class. If A is class then B and C should be an interface.
